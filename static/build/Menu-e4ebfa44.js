...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as compute_rest_props, v as validate_slots, a as assign, e as exclude_internal_props, b as classnames, G as empty, l as insert_dev, t as transition_in, n as group_outros, o as transition_out, p as check_outros, q as detach_dev, r as bubble, g as element, C as set_attributes, a2 as toggle_class, k as add_location, D as listen_dev, E as get_spread_update, K as add_render_callback, a3 as create_in_transition, a4 as create_out_transition, f as create_slot, x as update_slot_base, y as get_all_dirty_from_scope, z as get_slot_changes, h as space, j as attr_dev, m as append_dev, A as text, B as set_data_dev, O as noop, a5 as is_function, ae as construct_svelte_component_dev, af as compute_slots, a6 as createEventDispatcher, a1 as onMount, aa as browserEvent, ag as getTransitionDuration, Q as create_component, R as mount_component, T as destroy_component, u as binding_callbacks, X as globals, Y as Button } from './Button-1c2619f5.js';
import { b as backdropIn, a as backdropOut, I as InlineContainer, P as Portal } from './Portal-b6f3c987.js';
...
// (23:0) <Button color="light" on:click={toggle} size="lg">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(23:0) <Button color=\\\"light\\\" on:click={toggle} size=\\\"lg\\\">",
		ctx
	});
...
// (24:0) <Offcanvas theme="light" {isOpen} {toggle} header="Link" placement="start">
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 24, 4, 755);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(24:0) <Offcanvas theme=\\\"light\\\" {isOpen} {toggle} header=\\\"Link\\\" placement=\\\"start\\\">",
		ctx
	});
...
export { Menu as M };
//# sourceMappingURL=Menu-e4ebfa44.js.map
