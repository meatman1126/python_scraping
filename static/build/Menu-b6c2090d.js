...
// (22:0) <Button type="button" color="light" on:click={toggle} size="lg">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(22:0) <Button type=\\\"button\\\" color=\\\"light\\\" on:click={toggle} size=\\\"lg\\\">",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 23, 4, 718);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
export { Menu as M };
//# sourceMappingURL=Menu-b6c2090d.js.map
